    ...
    <div class="row g-5">
        ...
        <div class="col-lg-6">
            <div class="position-relative product-gallery">
                ...
                <!-- Orange Easy Peel Banner -->
                <div class="position-absolute top-0 start-0 m-3">
                    <span class="badge bg-warning text-dark fs-6 shadow-sm px-3 py-2">
                        EASY PEEL TECHNOLOGY <small class="fw-bold">PEEL 2–4X FASTER</small>
                    </span>
                </div>
              ...
              <div class="ctabox w3_bg">
                ...
                <div class="mb-4 step step-2 d-none">
                    ...
                    <div class="d-flex gap-3 flex-wrap">
                        @foreach($colors as $c)
                            <label class="color-option border rounded p-3 cursor-pointer shadow-sm">
                    ...
                    <div class="row g-3">
                        @foreach($sizes as $s)
                            <div class="col-6 col-md-4">
                                <label class="size-card border rounded p-3 text-center cursor-pointer shadow-sm h-100">
