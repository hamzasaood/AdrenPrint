...
<head>
    ...
    <title>FullyPrint || Design and Printing</title>
...
header .header-section .header-center .navigation .menu-button-right .main-menu__nav .main-menu__list li ul li.current > a, header .header-section .header-center .navigation .menu-button-right .main-menu__nav .main-menu__list li ul li:hover > a, header .header-section .header-center .navigation .menu-button-right .main-menu__nav .stricky-header .main-menu__list li ul li.current > a, header .header-section .header-center .navigation .menu-button-right .main-menu__nav .stricky-header .main-menu__list li ul li:hover > a {
                                ...
                                <div class="col-lg-6">
                                    <div class="product-text-container bg-white br-20">
                                        ...
                                        <p class="mb-24" id="modalProductDescription">
                                            The Clean Wave Washing Machine Automatic Washing Machine is engineered to make laundry effortless with its advanced
                                            cleaning technology. Featuring multiple wash cycles, water level sensors, and a quiet motor...
                                        </p>
                                        <p class="subtitle color-primary mb-24" id="modalProductStock"> in stock, ready to ship</p>
                                        <div class="function-bar mb-24">
                                            <div class="quantity quantity-wrap">
                                                <div class="input-area quantity-wrap quantity-modal">
                                                    <button class="minus" type="button">-</button>
                                            <input type="number" name="quantity" value="1" id="modal-quantity" data-index="" maxlength="2" size="1" step="1" min="1" max="5" class="number">
                                        ...
                                        <div class="row mb-24 row-gap-2">
                                            <div class="col-md-6" id="cart">
                                                <a id="modalCartBtn"   class="cus-btn w-100 text-center modalCartBtn">Add to cart</a>
                                            </div>
                                            <div class="col-md-6">
                                         ...
                                         <div class="row mb-24 row-gap-2">
                                            ...
                                            <div class="col-md-6" id="designmodal">
                                                <a id="modaldesignbtn" href="" class="cus-btn w-100 text-center btn-sec">Design</a>
                                            </div>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th id="product-col" class="table-col">
                                            <img class="product-img mb-16" src="{{asset('assets/media/products/product-1.png')}}" alt="">
                                            <span class="h6">
                                        ...
                                        <th class="table-col">
                                            <img class="product-img mb-16" src="{{asset('assets/media/products/product-2.png')}}" alt="">
                                            <span class="h6">
                                        ...
                                        <th class="table-col">
                                            <img class="product-img mb-16" src="{{asset('assets/media/products/product-3.png')}}" alt="">
                                            <span class="h6">
                                        ...
                                        <th class="table-col">
                                            <img class="product-img mb-16" src="{{asset('assets/media/products/product-4.png')}}" alt="">
                                            <span class="h6">
                                        ...
                                        <th class="table-col">
                                            <img class="product-img mb-16" src="{{asset('assets/media/products/product-5.png')}}" alt="">
                                            <span class="h6">
