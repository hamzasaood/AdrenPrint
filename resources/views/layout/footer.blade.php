    ...
    <div class="container">
        <div class="row row-gap-3 mb-24">
            ...
            <div class="col-lg-4 col-md-6 col-sm-7">
                ...
                <form action="https://uiparadox.co.uk/templates/print-hive/index.html" method="post"
                    class="newsletter-container mb-24">
...
<footer class="bg-white text-dark py-5 border border-top shadow-md">
    <div class="site-container">
        <div class="row g-4">
            <!-- Logo and Company Info -->
            <div class="col-lg-4 col-md-6">
                <div class="d-flex align-items-start footer-branding">
                    <div>
                        <h5 class="mb-1 fw-bold brand-yellow">ARDEN’S PRINT</h5>
                        <div class="mb-2">TOMBALL, TX</div>
                        <div class="mb-1 small">16131 N Eldridge Pkwy, Suite 108, Tomball, TX 77377</div>
                        <div class="mb-1 small">
                            <span class="fw-semibold">Phone:</span> 832 480 8080 <br />
                            <span class="fw-semibold">Email:</span>
                            <a href="mailto:info@ardensprint.com"
                                class="text-warning text-decoration-none">info@ardensprint.com</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- Bottom Bar -->
        <div class="d-flex flex-column flex-md-row align-items-center justify-content-between mt-5 pt-4 border-top">
            <div class="mb-3 mb-md-0 small">
                &copy; 2025 Arden’s Print
                <span class="payment-icons ms-3">
                    <a href="#" class="brand-yellow me-2"><i class="fab fa-cc-visa"></i></a>
                    <a href="#" class="brand-yellow me-2"><i class="fab fa-cc-paypal"></i></a>
                    <a href="#" class="brand-yellow"><i class="fab fa-cc-mastercard"></i></a>
                </span>
            </div>
            <div>
                <a href="#" class="brand-yellow me-3 small text-decoration-none">Privacy Policy</a>
                <a href="#" class="brand-yellow me-3 small text-decoration-none">Terms & Conditions</a>
                <a href="#" class="brand-yellow small text-decoration-none">Returns Policy</a>
            </div>
        </div>
    </div>
</footer>