 <footer class="bg-lightest-gray py-40 pb-32">
                <div class="container">
                    <div class="row row-gap-3 mb-24">
                        <div class="col-lg-4 col-md-5 col-sm-5">
                            <div class="footer-info-block">
                                <a href="{{url('/')}}" class="mb-16">
                                    <img src="{{asset('logo2.png')}}" alt="" style="width: 50%;">
                                </a>
                                <div class="mb-16">
                                    <a href="mailto:abc@sample.com" class="dark-gray">exampleinfo@gmail.com</a>
                                </div>
                                <div class="mb-16">
                                    <a href="tel:1235498" class="h6 fw-600 black">(+68) 123 456 7890</a>
                                </div>
                                <p class="dark-gray">218 Fifth Avenue, Heaven Tower</p>
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                            <h6 class="black fw-500 mb-24">Company</h6>
                            <ul class="list-unstyled mb-0">
                                <li class="mb-8">
                                    <a href="{{url('/contact')}}">Delivery Information</a>
                                </li>
                                <li class="mb-8">
                        ...
                        <div class="col-lg-2 col-md-3 col-sm-3 col-6">
                            <h6 class="black fw-500 mb-24">Resources</h6>
                            <ul class="list-unstyled mb-0">
                                <li class="mb-8">
                                ...
                                <li class="mb-8">
                                    <a href="{{url('/checkout')}}">Track My Order</a>
                                </li>
                                <li>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-7">
                            <h6 class="black fw-500 mb-24">Our Newsletter</h6>
                            <p class="mb-24">Subscribe to our newsletter and enjoy 20% off your first order!</p>
                            <form action="https://uiparadox.co.uk/templates/print-hive/index.html" method="post" class="newsletter-container mb-24">
                            ...
                            <ul class="list-unstyled social-link">
                                ...
                                <li>
                                    <a href="#" class="blog-icons">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                            <path d="M11.8683 8.46864L19.1537 0H17.4273L11.1014 7.3532L6.04897 0H0.221558L7.86186 11.1193L0.221558 20H1.94805L8.62833 12.2348L13.9641 20H19.7915L11.8679 8.46864H11.8683ZM9.50367 11.2173L8.72954 10.1101L2.57013 1.29967H5.22192L10.1926 8.40994L10.9668 9.51718L17.4281 18.7594H14.7763L9.50367 11.2177V11.2173Z" fill="#0D0908"></path>
                                        </svg>
                                    </a>
                                </li>
                                <li>
                    ...
                    <div class="footer-bottom-bar d-flex align-items-end flex-wrap row-gap-2 justify-content-between">
                        <div>
                            <div class="d-flex align-items-center gap-32 mb-16">
                                <div class="drop-container">
                                    <div class="wrapper-dropdown black" id="dropdown">
                                        <span class="selected-display black" id="destination">English</span>
                                        ...
                                        <ul class="topbar-dropdown footer-dropdown bg-lightest-gray">
                                ...
                                <div class="drop-container">
                                    <div class="wrapper-dropdown black" id="dropdown2">
                                        <span class="selected-display black d-inline-flex align-items-center gap-8"
                                            id="destination2">
                                            <img src="{{asset('assets/media/icons/usd.png')}}" alt="">
                                            USD
                                        </span>
                                        ...
                                        <ul class="topbar-dropdown footer-dropdown bg-lightest-gray">
                                            ...
                                            <li class="item black d-flex align-items-center gap-8">
                                                <img src="{{asset('assets/media/icons/aed.png')}}" alt="">
                                                AED
                                            </li>
                                            <li class="item black d-flex align-items-center gap-8">
                                                <img src="{{asset('assets/media/icons/lb.png')}}" alt="">
                                                LB
                                            </li>
                                            <li class="item black d-flex align-items-center gap-8">
                                                <img src="{{asset('assets/media/icons/dem.png')}}" alt="">
                                                DEM
                                            </li>
                                        </ul>
                                    </div>
                            ...
                            <p class="dark-gray">@2025 All Rights Copyright <a href="#" class="black fw-700"> FullyPrint</a>
                                </p>
                        </div>
                       
                        <div class="payment-cards d-flex align-items-center gap-16">
                            <div class="card-block">
                                <img src="{{asset('assets/media/icons/card-1.png')}}" alt="">
                            </div>
                            <div class="card-block">
                                <img src="{{asset('assets/media/icons/card-2.png')}}" alt="">
                            </div>
                            <div class="card-block">
                                <img src="{{asset('assets/media/icons/card-3.png')}}" alt="">
                            </div>
                            <div class="card-block">
                                <img src="{{asset('assets/media/icons/card-4.png')}}" alt="">
                            </div>
                            <div class="card-block">
                                <img src="{{asset('assets/media/icons/card-5.png')}}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
