...
{{-- <header>
    <div class="header-section">
        <div class="bg-color-primary">
            <div class="container">
                <div class="header-top">
                    ...
                    <p class="white d-sm-block d-none"><span class="fw-500">Black Friday Sale:</span> Save up to 60%
                        with code <span class="fw-500">Trendy Tykes.</span></p>
                    <div class="header-end">
                        <div class="drop-container">
                            <div class="wrapper-dropdown white" id="dropdown20">
                                <span class="selected-display white d-inline-flex align-items-center gap-8"
                                    id="destination002">
                                    <img src="{{asset('assets/media/icons/usd.png')}}" alt="">
                                    USD
                                </span>
                                <svg id="drp-arrow652" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        ...
                        <div class="drop-container">
                            <div class="wrapper-dropdown white" id="dropdown04">
                                <span class="selected-display white" id="destination04">English</span>
                                <svg id="drp-arrow04" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg" class="arrow transition-all ml-auto rotate-180">
                                    <path d="M7 14.5l5-5 5 5" stroke="currentColor" stroke-width="1.5"
                                        stroke-linecap="round" stroke-linejoin="round"></path>
                                </svg>
        ...
        <div class="container" style="    background: #faf9f6;    border-bottom: 2px solid #1f993d;">
                            ...
                            <div class="menu-button-right">
                                <div class="main-menu__nav">
                                    <ul class="main-menu__list">
                                        ...
                                        <li>
                                            <a href="{{url('/about')}}"
                                                class="@if(request()->is('about')) active @endif">About Us</a>
                                        </li>
                                        <li class="dropdown">
                                            ...
                                            <ul class="sub-menu">
                                                <li><a href="{{url('/shop')}}"
                                                        class="@if(request()->is('/shop')) active @endif">Shop</a></li>
                                                <li><a href="{{url('/product-detail')}}"
                                                        class="@if(request()->is('/product-detail')) active @endif">Product
                                                        Detail</a></li>
                                                <li><a href="{{url('/wishlist')}}"
                                                        class="@if(request()->is('/wishlist')) active @endif">Wishlist</a>
                                                </li>
                                                <li><a href="{{url('/cart')}}"
                                                        class="@if(request()->is('/cart')) active @endif">Cart</a></li>
                                                <li><a href="{{url('/checkout')}}"
                                                        class="@if(request()->is('/checkout')) active @endif">Checkout</a>
                                                </li>
                                            </ul>
                                        </li>
                                        ...
                                        <li>
                                            <a href="{{url('/contact')}}"
                                                class="@if(request()->is('contact')) active @endif">Contact Us</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-8 col-sm-7 col-7">
                        <div class="header-buttons">
                            <div class="logo-icon d-sm-block d-none">
                                <a href="javascript:;" id="magnifying-btn" class="button-block search-toggler">
                            ...
                            @else
                            <a href="{{ route('login') }}" class="button-block d-flex">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none">
                                    <path
                                        d="M12 0C8.51067 0 5.67188 2.8388 5.67188 6.32812C5.67188 9.81745 8.51067 12.6562 12 12.6562C15.4893 12.6562 18.3281 9.81745 18.3281 6.32812C18.3281 2.8388 15.4893 0 12 0ZM12 11.25C9.28608 11.25 7.07812 9.04205 7.07812 6.32812C7.07812 3.6142 9.28608 1.40625 12 1.40625C14.7139 1.40625 16.9219 3.6142 16.9219 6.32812C16.9219 9.04205 14.7139 11.25 12 11.25Z"
...
<nav class="navbar bg-white shadow-sm">
    <div class="site-container">
        <div class="d-flex justify-content-between align-items-center w-100">
            ...
            <!-- Center: logo -->
            <a class="navbar-brand mx-auto position-absolute start-50 translate-middle-x @if(request()->is('/')) active @endif"
                href="{{url('/')}}">
                <img src="{{asset('assets/media/logo.gif')}}" alt="Logo">
            </a>

            {{-- <!-- Right section: icons -->
            <div class="d-flex gap-3 fs-5 icons-regular">
                {{-- <a href="#"><i class="fa-regular fa-user text-dark"></i></a>
                <a href="#"><i class="fa-solid fa-magnifying-glass text-dark"></i></a>
                <a href="#"><i class="fa-regular fa-heart text-dark"></i></a>
                <a href="#" class="cart-button"><i class="fa-solid fa-bag-shopping text-dark"></i></a>
                {{-- <a href="{{ route('login') }}" class="button-block d-flex">
                ...
                <div class="col-lg-3 col-md-8 col-sm-7 col-7">
                    <div class="header-buttons">
                        ...
                        @if(Auth::check())
                        <nav class="navigation d-flex align-items-center justify-content-center" style="width: 15%;">
                            <div class="menu-button-right">
                                <div class="main-menu__nav">
                                    <ul class="main-menu__list">
                                        {{-- <li class="dropdown">
            ...
            <div class="col-lg-3 col-md-8 col-sm-7 col-7">
                <div class="header-buttons d-flex align-items-center justify-content-end gap-3">
                    ...
                    <a href="#" class="button-block d-flex align-items-center position-relative cart-button">
                        ...
                        <span class="cart-count-badge position-absolute top-0 start-100 translate-middle">0</span>
                    </a>

                    {{-- <!-- Mobile Menu -->
                    <a href="#" class="main-menu__toggler mobile-nav__toggler d-flex align-items-center">
                        Menu <img src="{{asset('assets/media/icons/menu-2.png')}}" alt="">
                    </a> --}}
            ...
            <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar"
                ...
                <div class="offcanvas-body">
                    <ul
                        class="navbar-nav flex-column gap-3 border border-bottom border-start-0 border-end-0 border-top-0">
                        <li class="nav-item dropdown list-unstyled">
                            <a href="#" class="text-dark text-decoration-none nav-link dropdown-toggle" role="button"
                                data-bs-toggle="dropdown" aria-expanded="false">DTF
                                TRANSFERS</a>
                            <ul class="dropdown-menu border-0 list-unstyled">
                                <li><a class="dropdown-item" href="{{url('/dtf/transfer_by_size')}}">DTF Transfer By
                                        Size</a>
                                </li>
                        ...
                        <li class=""><a href="{{url('/about')}}"
                                style="text-decoration:none; color:black; display:block;">About Us</a></li>
                        <li class="mb-3"><a href="{{url('/contact')}}"
                                style="text-decoration:none; color:black; display:block;">Contact</a></li>
                    </ul>
                    ...
                    <div class="gap-3 mt-3 fs-5 align-items-center flex-wrap d-sm-none d-flex">
                        ...
                        <a href="#" class="p-2"><i class="fa-solid fa-magnifying-glass text-dark"></i></a>
                        <a href="#" class="p-2"><i class="fa-regular fa-heart text-dark"></i></a>
                        <a href="cart.html" class="p-2"><i class="fa-solid fa-bag-shopping text-dark"></i></a>
                    </div>
                </div>
            </div>
        </div>
