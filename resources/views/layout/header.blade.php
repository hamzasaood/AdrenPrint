                ...
                <div class="bg-color-primary">
                    <div class="container" >
                        <div class="header-top">
                            ...
                            <p class="white d-sm-block d-none"><span class="fw-500">Black Friday Sale:</span> Save up to 60% with code <span class="fw-500">Trendy Tykes.</span></p>
                                        ...
                                        <div class="main-menu__nav">
                                            <ul class="main-menu__list">
                                                ...
                                                <li class="dropdown">
                                                    ...
                                                    <ul class="sub-menu">
                                                        <li><a href="{{url('/shop')}}" class="@if(request()->is('/shop')) active @endif">Shop</a></li>
                                                        <li><a href="{{url('/product-detail')}}" class="@if(request()->is('/product-detail')) active @endif">Product Detail</a></li>
                                                        <li><a href="{{url('/wishlist')}}" class="@if(request()->is('/wishlist')) active @endif">Wishlist</a></li>
                                                        <li><a href="{{url('/cart')}}" class="@if(request()->is('/cart')) active @endif">Cart</a></li>
                                                        <li><a href="{{url('/checkout')}}" class="@if(request()->is('/checkout')) active @endif">Checkout</a></li>
                                                    </ul>
                                                </li>
                                                
                                                <li>
                                                    <a href="{{url('/contact')}}" class="@if(request()->is('contact')) active @endif">Contact Us</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
