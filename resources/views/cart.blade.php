...
@section('content')
          ...
          @if(!empty($item['design_preview']))
            <img src="{{ $item['design_preview'] }}" alt="Design" style="max-width:120px; border:1px solid #ddd;">
          @endif
        </div>
                                            ...
                                            <td>
                                                <div class="quantity quantity-wrap">
                                                    <div class="input-area quantity-wrap">
                                                        ...
                                                        <input type="text" name="quantity" value="{{ $item['quantity'] }}" maxlength="2" size="1"
                                                            class="number">
                            ...
                            <div class="table-bottom-row bg-white">
                                ...
                                <form action="https://uiparadox.co.uk/templates/print-hive/checkout.html" method="post" class="contact-form d-flex align-items-center gap-16">
                            ...
                            <tr class="table-row">
                                <td class="pd">
                                    <div class="product-detail-box">
                                        ...
                                        <!-- Remove button -->
                                        <a href="javascript:void(0)" class="h5 dark-black remove-item"><i class="fal fa-times"></i></a>
                                        ...
                                        <div class="img-block" style="width:140px">
                                            ...
                                            @elseif($item['type'] ?? '' === 'dtf' && !empty($item['artwork']))
                                                <img src="{{ asset($item['artwork']) }}" alt="" style="max-width:120px; border:1px solid #ddd; cursor:pointer;"
