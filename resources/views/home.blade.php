      ...
      <div class="row align-items-center justify-content-between">
        ...
        <div class="col-lg-6 col-md-6">
          ...
          <div class="d-flex flex-column flex-sm-row gap-3">
            <a href="{{url('/dtf/transfer_by_size/')}}"
              class="btn btn-light border px-4 py-3 fw-semibold d-flex align-items-center justify-content-center">
              Order DTF Transfers by Size
              <svg xmlns="http://www.w3.org/2000/svg" class="ms-2" width="20" height="20" viewBox="0 0 24 24" fill="none"
        ...
        <div class="col-lg-6 col-md-6 text-center mt-4 mt-md-0">
          <img
            src="https://cdn.shopify.com/s/files/1/0651/6300/2098/files/homepage-banner-image-collage-min.webp?v=1751918319"
        ...
        <div class="col-sm-6 col-lg-4">
          <div class="d-flex align-items-start">
            ...
            <div>
              ...
              <p class="mb-0" style="color:#222;">Vibrant, durable DTF prints made with premium tech and materials—your
                best, guaranteed.</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-6 col-lg-4">
          <div class="d-flex align-items-start">
            ...
            <div>
              ...
              <p class="mb-0" style="color:#222;">Premium DTF at budget-friendly prices, plus bulk discounts & perks for
                lasting value.</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-6 col-lg-4">
          <div class="d-flex align-items-start">
            ...
            <div>
              ...
              <p class="mb-0" style="color:#222;">Fast, high-quality DTF transfers delivered on time to meet your
                deadlines.</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-6 col-lg-4">
          <div class="d-flex align-items-start">
            ...
            <div>
              ...
              <p class="mb-0" style="color:#222;">Custom or ready-to-press DTF for holidays, events, or everyday
                needs—covered.</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-6 col-lg-4">
          <div class="d-flex align-items-start">
            ...
            <div>
              ...
              <p class="mb-0" style="color:#222;">Pair our DTF transfers with blank apparel for easy custom
                creations—business or hobby.</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-6 col-lg-4">
          <div class="d-flex align-items-start">
            ...
            <div>
              ...
              <p class="mb-0" style="color:#222;">From design uploads to final application, our expert team supports you
      ...
      <div class="row g-4">
        <div class="col-12 col-md-4">
          <a href="{{url('/dtf/transfer_by_size')}}" class="text-decoration-none text-dark">
            <div class="card shadow h-100 border-0 hover-card">
              <img src="{{asset('/READY-TO-PRESS-DTF.webp')}}" class="card-img-top img-fluid" alt="DTF Transfer by Size">
        ...
        <div class="col-12 col-md-4">
          <a href="/gangsheet" class="text-decoration-none text-dark">
            <div class="card shadow h-100 border-0 hover-card">
              <img src="{{asset('/create-gang.webp')}}" class="card-img-top img-fluid" alt="DTF Gang Sheet Builder">
              <div class="card-body p-4">
        ...
        <div class="col-12 col-md-4">
          <a href="{{url('/dtf/upload-gangsheet')}}" class="text-decoration-none text-dark">
            <div class="card shadow h-100 border-0 hover-card">
              <img src="{{asset('upload-gang.webp')}}" class="card-img-top img-fluid" alt="Upload Print Ready File">
              <div class="card-body p-4">
    ...
    <div class="container text-center" style="    padding-top: 1%;padding-bottom:1%;padding-left:7%;padding-right:7%;">
      ...
      <div class="text-center mb-5">
        ...
        <p class="text-muted">
          ...
          Whether you're looking for blank t-shirts, hoodies, or sweatshirts, our collection offers high-quality blanks at
          affordable prices.
        </p>
      </div>
            ...
            <div class="product-card h-100 card">
              ...
              <a href="{{ url('/product/' . $product->slug) }}">
                ...
                <div class="img-wrapper">
                  ...
                  @if($product->image)
                    <img src="{{ asset('images/' . $product->image) }}" class="img-fluid" style="height: 230px;"
                      alt="{{ $product->name }}">
                  @elseif($product->main_image)

                    <img src="https://www.ssactivewear.com/{{$product->main_image}}" class="img-fluid" style="height: 230px;"
                      alt="{{ $product->name }}">

                  @else
                    <img src="{{ asset('images/no-image.png') }}" class="img-fluid" style="height: 230px;"
                      alt="{{ $product->name }}">
