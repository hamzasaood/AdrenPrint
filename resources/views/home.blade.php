...
<style>
    ...
    .card img {
        ...
        object-fit: cover;
            ...
            <!-- HERO BANNER START -->
            <section class="hero-banner py-40">
                <div class="hero-banner-wrapper">
                    <div class="container">
                        <div class="row align-items-center row-gap-4">
                            <div class="col-lg-6 col-md-6">
                                <div class="hero-content-block">
                                    <div class="eyebrow mb-16 wow fadeInLeft animated" data-wow-delay="1.9s">Rated 5.0
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                            <circle cx="12" cy="12" r="12" fill="#FAFAFA"/>
                                            <path d="M12 4L13.7961 9.52786H19.6085L14.9062 12.9443L16.7023 18.4721L12 15.0557L7.29772 18.4721L9.09383 12.9443L4.39155 9.52786H10.2039L12 4Z" fill="#FF7A00"/>
                                        </svg>      
                                    </div>
                                    <h1 class="fw-500 black mb-32 wow fadeInLeft animated" data-wow-delay="2s">Hassle-free Design <br class="d-lg-block d-none"> and <span class="highlighted-text fw-700"> Printing <span class="text-line"><img src="assets/media/banner/banner-line.png" alt=""></span> </span></h1>
                                    <ul class="list-unstyled mb-48 wow fadeInLeft animated" data-wow-delay="2.1s">
                                        <li class="mb-16">
                                            <div class="check-circle">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="12" viewBox="0 0 16 12" fill="none">
                                                    <path d="M15.0376 0.923655C14.8213 0.707374 14.4706 0.707374 14.2543 0.923655L5.27651 9.90148L1.74527 6.37021C1.52902 6.1539 1.17833 6.1539 0.962016 6.37021C0.745734 6.58649 0.745734 6.93716 0.962016 7.15347L4.88493 11.0764C5.10112 11.2926 5.45193 11.2926 5.66818 11.0764L15.0376 1.70691C15.2538 1.4906 15.2538 1.13994 15.0376 0.923655Z" fill="#0C0C0D"/>
                                                </svg>
                                            </div>
                                    ...
                                    <a href="{{url('/shop')}}" class="cus-btn wow fadeInLeft animated" data-wow-delay="2.2s">Shop Now</a>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6">
                                <div class="row row-gap-3">
                                    <div class="col-6">
                                        <div class="banner-images-container">
                                            <div class="image-col w-100 h-100 mb-24 wow zoomIn animated" data-wow-delay="1.8s">
                                                <img src="assets/media/banner/banner-image-1.png" alt="" class="br-12 w-100 h-100 object-fit-cover">
                                            </div>
                                            <div class="image-col w-100 h-100 wow zoomIn animated" data-wow-delay="1.82s">
                                                <img src="assets/media/banner/banner-image-2.png" alt="" class="br-12 w-100 h-100 object-fit-cover">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-6 mt-48">
                                        <div class="banner-images-container">
                                            <div class="image-col w-100 h-100 mb-24 wow zoomIn animated" data-wow-delay="1.85s">
                                                <img src="assets/media/banner/banner-image-3.png" alt="" class="br-12 w-100 h-100 object-fit-cover">
                                            </div>
                                            <div class="image-col w-100 h-100 wow zoomIn animated" data-wow-delay="1.89s">
                                                <img src="assets/media/banner/banner-image-4.png" alt="" class="br-12 w-100 h-100 object-fit-cover">
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="collection-sec pt-80 pb-40">
                <div class="container">
                    <h2 class="black fw-500 mb-48 text-center">Shop by Categories</h2>
                            ...
                            <div class="col-xl-2 col-lg-3 col-md-3 col-sm-4 col-6">
                                <a href="{{url('/shop')}}" class="collection-block w-100">
                                    <div class="image-box mb-12">
                                        <img src="{{ asset('images/'.$category->image )}}" style="height: 130px;" alt="">
                                    </div>
                                    <div class="text-box">
                                        <h6 class="title-text fw-500 text-center">{{ $category->name }}</h6>
                                        <p class="dark-gray">{{ $category->product_count }}</p>
                                    </div>
                                </a>
                            </div>
                        @endforeach
            ...
            <!-- PRODUCT TABS START -->
<section class="product-sec py-80">
    <div class="container">
        <div class="heading-container text-center">
            <div class="eyebrow mb-16">Products</div>
            <h2 class="black fw-500 mb-16">Handpicked Premium Selections</h2>
        </div>
        ...
        <div class="product-wrapper">
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6">
                                    <div class="latest-product-card">
                                        <div class="image-box mb-16">
                                            ...
                                            <a href="{{ url('/product-detail/'.$product->id) }}">
                                                <img src="{{ asset('images/'.$product->image) }}" 
                                                     class="product-image" style="height: 230px;"
                                                     alt="{{ $product->name }}">
                                            </a>
                                            <div class="side-icons">
                                                <ul class="list-unstyled">
                                                    ...
                                                    <li>
                                                        ...
                                                        <a href="javascript:void(0);"  class="btn quick-view-btn"  data-bs-toggle="modal" data-bs-target="#productQuickView"
                                                          data-id="{{ $product->id }}" data-name="{{ $product->name }}" data-price="{{ $product->price }}"
                                                          data-regular-price="{{ $product->price }}" data-sale-price="{{ $product->sale_price }}"
                                                          data-image="{{ asset('images/'.$product->image) }}" data-description="{{ $product->description }}"
                                                          data-design = "{{$product->design_type}}" data-stock="{{ $product->stock }}" data-category="{{ $product->category->name ?? '' }}">
                                        ...
                                        <div class="product-desc">
                                            ...
                                            <a href="#" class="cart-btn modalCartBtn" id="modalCartBtn" data-product-id="{{ $product->id }}">
            ...
            <section class="promotion-sec py-40">
                <div class="container">
                    <div class="heading-container text-center">
            <div class="eyebrow mb-16">DTF Transfers</div>
            <h2 class="black fw-500 mb-16">Select the DTF Product That Works Best for You</h2>
        </div>
                    <div class="row row-gap-4">
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/dtf/transfer_by_size')}}" class="text-decoration-none text-dark">
                            <div class="card shadow h-100 border-0 hover-card">
                                <img src="{{asset('/READY-TO-PRESS-DTF.webp')}}" class="card-img-top" alt="DTF Transfer by Size">
                                <div class="card-body">
                                    <h5 class="card-title fw-bold">DTF Transfer by Size</h5>
                                    <p class="card-text text-muted">
                                        Order high-quality DTF transfers by the sheet or size you need.
                                    </p>
                                    <span class="btn btn-success w-100">Choose</span>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-md-4">
                        <a href="/gangsheet" class="text-decoration-none text-dark">
                            <div class="card shadow h-100 border-0 hover-card">
                                <img src="{{asset('/create-gang.webp')}}" class="card-img-top" alt="DTF Gang Sheet Builder">
                                <div class="card-body">
                                    <h5 class="card-title fw-bold">DTF Gang Sheet Builder</h5>
                                    <p class="card-text text-muted">
                                        Create your custom gang sheet directly in our online builder.
                                    </p>
                                    <span class="btn btn-success w-100">Start Building</span>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/dtf/upload-gangsheet')}}" class="text-decoration-none text-dark">
                            <div class="card shadow h-100 border-0 hover-card">
                                <img src="{{asset('upload-gang.webp')}}" class="card-img-top" alt="Upload Print Ready File">
                                <div class="card-body">
                                    <h5 class="card-title fw-bold">DTF Gang Sheet: Upload</h5>
                                    <p class="card-text text-muted">
                                        Already have a print-ready file? Upload and order instantly.
                                    </p>
                                    <span class="btn btn-success w-100">Upload File</span>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-md-3">
                        <a href="#" class="text-decoration-none text-dark">
                            <div class="card shadow h-100 border-0 hover-card">
                                <img src="{{asset('/premade-gang.webp')}}" class="card-img-top" alt="Ready Designs">
                                <div class="card-body">
                                    <h5 class="card-title fw-bold">Pre-Made Designs</h5>
                                    <p class="card-text text-muted">
                                        Browse our collection of pre-made designs, and get 
                                        ready to print.
                                    </p>
                                    <span class="btn btn-success w-100">Browse Designs</span>
                                </div>
                            </div>
                        </a>
                    </div>
    ...
    <div class="container">
                ...
                <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6">
                    <div class="latest-product-card">
                        <div class="image-box mb-16">
                            ...
                            @endif
                            <a href="{{ url('/product-detail/'.$product->id) }}">
                                <img src="{{ asset('images/'.$product->image) }}" style="height: 250px;"
                            ...
                            <div class="side-icons">
                                <ul class="list-unstyled">
                                    @if($product->design_type === 'dtf')
                                    <li>
                                        <a href="{{ url('/gang-sheet/'.$product->id) }}"><i class="fa-light fa-pencil-slash"></i></a>
                                    </li>
                                    @endif
                                    <li>
                                        <a href="#"><i class="fa-light fa-heart"></i></a>
       ...
       data-category="{{ $product->category->name ?? '' }}">
        <i class="fa-regular fa-eye"></i>
                                    ...
                                    <li>
                                        <a href="#" class="zui-wrapper-button" data-bs-toggle="modal" data-bs-target="#comparepopup">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="17" viewBox="0 0 16 17" fill="none">
                                                <path d="M2 2h12v2H2V2zm0 5h12v2H2V7zm0 5h12v2H2v-2z" fill="#363636"/>
                                            </svg>
                                        </a>
                                    </li>
                                </ul>
                        ...
                        <div class="product-desc d-flex flex-column justify-content-between" style="min-height: 150px;">
                            <div>
                                <a href="{{ url('/product-detail/'.$product->id) }}"
                                   class="product-title h6 fw-500 mb-12">{{ $product->name }}</a>
                                <p class="black fw-600">
                                    @if($product->sale_price && $product->sale_price < $product->price)
                                        <span class="subtitle text-decoration-line-through fw-400 light-gray">
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-2">
                                <a href="javascript:void(0)" class="cart-btn modalCartBtn" id="modalCartBtn" data-product-id="{{ $product->id }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="white" viewBox="0 0 24 24">
                                        <path d="M7 18c-1.104 0-2 .896-2 2s.896 2 2 2 
                                                 2-.896 2-2-.896-2-2-2zm10 0c-1.104 
                                                 0-2 .896-2 2s.896 2 2 2 2-.896 
                                                 2-2-.896-2-2-2zM7.334 14l.941-2h8.297c.791 
                                                 0 1.488-.465 1.803-1.182l2.861-6.447A1 
                                                 1 0 0 0 20.297 3H5.21l-.94-2H0v2h2l3.6 
                                                 7.59-1.35 2.45C3.52 13.37 4.48 15 
                                                 6 15h12v-2H7.334z"/>
                                    </svg>
                                </a>
        ...
        <div class="text-center">
            <a href="{{ url('/shop') }}" class="cus-btn-2">See All Products</a>
        </div>
    </div>
</section>
                    ...
                    <div class="row row-gap-4">
                        <div class="col-xl-4 col-md-4 col-sm-6">
                            <div class="process-card">
                                ...
                                <a href="{{url('/about')}}" class="black text-decoration-underline">Read More</a>
                            </div>
                        </div>
                        <div class="col-xl-4 col-md-4 col-sm-6">
                            <div class="process-card">
